...
# Northern Hemisphere
ring(start_index = 0, end_index = 6, phys_theta_v = 0.1587, phys_sphere_radius = 0.9652, phys_led_spacing = 0.123, map_ring_rad = 30, map_width = 400, map_height = 400, is_clockwise = 1, is_circle = 1, theta_h_offset = 0)
ring(start_index = 7, end_index = 21, phys_theta_v = 0.2870, phys_sphere_radius = 0.9652, phys_led_spacing = 0.123, map_ring_rad = 40, map_width = 400, map_height = 400, is_clockwise = 1, is_circle = 1, theta_h_offset = 0)
ring(start_index = 22, end_index = 42, phys_theta_v = 0.4153, phys_sphere_radius = 0.9652, phys_led_spacing = 0.123, map_ring_rad = 50, map_width = 400, map_height = 400, is_clockwise = 1, is_circle = 1, theta_h_offset = 0)
ring(start_index = 43, end_index = 69, phys_theta_v = 0.5436, phys_sphere_radius = 0.9652, phys_led_spacing = 0.123, map_ring_rad = 60, map_width = 400, map_height = 400, is_clockwise = 1, is_circle = 1, theta_h_offset = 0)
ring(start_index = 70, end_index = 101, phys_theta_v = 0.6719, phys_sphere_radius = 0.9652, phys_led_spacing = 0.123, map_ring_rad = 70, map_width = 400, map_height = 400, is_clockwise = 1, is_circle = 1, theta_h_offset = 0)
